// KFin company list — extracted from SPA bundle (ipostatus.kfintech.com)
// Update periodically as new IPOs are added
export const KFIN_COMPANIES: { clientId: string; name: string }[] = [
...
export function findKfinClientId(companyName: string): string | null {
  const lower = companyName.toLowerCase();
  const match = KFIN_COMPANIES.find(

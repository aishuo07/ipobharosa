    ...
    <main style={{ fontFamily: "system-ui, -apple-system, sans-serif", color: "#1A2B25", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "80px 20px 60px", textAlign: "center", background: "linear-gradient(180deg, #E8F2ED 0%, #fff 100%)" }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: 42, fontWeight: 900, lineHeight: 1.1, margin: "0 0 16px", letterSpacing: -1 }}>
            IPOBharosa
          </h1>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/board" style={{ display: "inline-block", padding: "14px 32px", fontSize: 16, fontWeight: 700, background: "#237355", color: "#fff", borderRadius: 10, textDecoration: "none" }}>
              View IPO Board →
            </Link>
            <a href="https://github.com/aishuo07/ipobharosa" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", padding: "14px 32px", fontSize: 16, fontWeight: 700, background: "#fff", color: "#237355", borderRadius: 10, textDecoration: "none", border: "1px solid #DEE1D9" }}>
              ⭐ GitHub
            </a>
          </div>
        </div>
      ...
      <section style={{ padding: "60px 20px", maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
          {[
            { icon: "🔍", title: "Auto-Discovered IPOs", desc: "Pipeline automatically finds new IPOs from NSE/BSE. You never miss one." },
            { icon: "✅", title: "Verified Data", desc: "Every IPO cross-checked against NSE and BSE official sources. 10/10 fields verified." },
            { icon: "📈", title: "Live GMP & Subscription", desc: "Real-time Grey Market Premium and subscription numbers from official exchange data." },
            { icon: "🎫", title: "Allotment Check", desc: "Check your IPO allotment status across 8 registrars with one click." },
            { icon: "🏦", title: "PAN Card Manager", desc: "Save PAN cards once. Auto-use across all allotment checks. Never type again." },
            { icon: "📱", title: "PWA + Android App", desc: "Works on any device. Install as app. Android APK available for download." },
            { icon: "🌙", title: "Dark Mode", desc: "Easy on the eyes. Light and dark themes for day and night use." },
            { icon: "🆓", title: "100% Free & Open Source", desc: "No ads, no paywalls, no data selling. View the code on GitHub." },
          ].map((f) => (
      ...
      <section style={{ padding: "48px 20px", background: "#173C32", color: "#fff", textAlign: "center" }}>
        <div style={{ maxWidth: 640, margin: "0 auto", display: "flex", gap: 40, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <div><div style={{ fontSize: 32, fontWeight: 900 }}>8</div><div style={{ fontSize: 13, opacity: 0.7 }}>Registrar Integrations</div></div>
      ...
      <section style={{ padding: "60px 20px", textAlign: "center" }}>
        ...
        <Link href="/board" style={{ display: "inline-block", padding: "14px 40px", fontSize: 16, fontWeight: 700, background: "#237355", color: "#fff", borderRadius: 10, textDecoration: "none" }}>
          Open IPO Board →
        </Link>
      </section>
